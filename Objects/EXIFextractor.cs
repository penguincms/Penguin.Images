...
namespace Penguin.Images.Objects
{
    ...
    public class EXIFextractor : IEnumerable
    {
        ...
        /// "Gps DestDist"
        /// </summary>
        public object this[string index] => this.properties[index];
        ...
        private void buildDB(System.Drawing.Imaging.PropertyItem[] parr)
        {
            ...
            {
                string v = "";
                string name = (string)this.myHash[p.Id];
    ...
    internal class EXIFextractorEnumerator : IEnumerator
    {
        ...
        {
            if (this.index != null && this.index.MoveNext())
            {
                return true;
            }
            else
    ...
    internal class Rational
    {
        ...
        public double ToDouble()
        {
            ...
            return Math.Round(Convert.ToDouble(this.n) / Convert.ToDouble(this.d), 2);
        }
